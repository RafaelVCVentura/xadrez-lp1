        ...
        for (int x = 0; x < 8; x++) {
            for (int y = 0; y < 8; y++) {
                ...
                if (casa.possuiPeca()) {
                    ...
                    switch (peca.getTipo()) {
                        case Peca.PEAO_BRANCA:
                            casaGUI.desenharPeaoBranca();
                            break;
                        case Peca.TORRE_BRANCA:
                            casaGUI.desenharTorreBranca();
                            break;
                        case Peca.CAVALO_BRANCA:
                            casaGUI.desenharCavaloBranca();
                            break;
                        case Peca.BISPO_BRANCA:
                            casaGUI.desenharBispoBranca();
                            break;
                        case Peca.RAINHA_BRANCA:
                            casaGUI.desenharRainhaBranca();
                            break;
                        case Peca.REI_BRANCA:
